                    ...
                    <div id="carousel" className="carousel slide">
                        <div className="carousel-inner">
                            <div className="carousel-item active">
                                <div className="row">
                                    <div className="col-lg-4">
                                        <img className="float-right testimonial-image" src="./img/testimonial-1.jpg" alt=""></img>
                                    </div>
                                    <div className="col-lg-6">
                                        <h3 className="call-to-action-heading">Sheraz</h3>
                            ...
                            <div className="carousel-item">
                                <div className="row">
                                    <div className="col-lg-4">
                                        <img className="float-right testimonial-image" src="img/testimonial-2.jpg" alt=""></img>
                                    </div>
                                    <div className="col-lg-6">
                            ...
                            <div className="carousel-item">
                                <div className="row">
                                    <div className="col-lg-4">
                                        <img className="float-right testimonial-image" src="img/testimonial-3.jpg" alt=""></img>
                                    </div>
                                    <div className="col-lg-6">
